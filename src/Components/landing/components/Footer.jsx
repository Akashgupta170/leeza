...
import facebook from"../../assest/landingassests/socialmedia/facebook.png";
import instagram from"../../assest/landingassests/socialmedia/instagram.png";
import linkedin from"../../assest/landingassests/socialmedia/linkedin.png";
import twitter from"../../assest/landingassests/socialmedia/twitter.png";
...
function Footer() {
  ...
  return (
    <footer className="bg-[#0C3891] py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className='mt-4 max-w-48'>
              <p className='text-white  text-lg'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corrupti consequuntur sunt quis, cum blanditiis ipsam optio ipsa architecto mollitia molestiae!</p>
            </div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <ScrollLink
                  ...
                  duration={1000}
                  offset={-50}
                  className="text-white cursor-pointer hover:text-blue-500 focus:outline-none"
                >
                  Features
                </ScrollLink>
              </li>
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <ScrollLink to="home" smooth={true} duration={500} offset={0} className="cursor-pointer text-lg text-white hover:text-gray-200">Upcoming events</ScrollLink>
              </li>
              <li>
              <ScrollLink to="work" smooth={true} duration={500} offset={0} className="cursor-pointer text-lg text-white hover:text-gray-200">Opportunities</ScrollLink>
              </li>
              <li>
              <ScrollLink to="work" smooth={true} duration={500} offset={0} className="cursor-pointer text-lg text-white hover:text-gray-200">Join as a companies</ScrollLink>
              </li>
              <li>
              <ScrollLink to="testimonial" smooth={true} duration={500} offset={0} className="cursor-pointer text-lg text-white hover:text-gray-200">Join as a creatives</ScrollLink>
              </li>
              <li>
              <ScrollLink to="home" smooth={true} duration={500} offset={0} className="cursor-pointer text-lg text-white hover:text-gray-200">FAQ</ScrollLink>
              </li>
            </ul>
          </div>
          {/* Legal Links */}
          <div className="flex flex-col items-start">
            <p className=" text-lg text-white">Get the latest news updates and tips</p>
            <div class="flex items-center mt-4">
              <input
                type="text"
                class="w-full p-2 border border-white focus:outline-none focus:ring-2 focus:ring-[#0C3891] bg-[#0C3891] text-white placeholder-white"
                placeholder="Enter text here"
              />
              
              <button class="bg-white text-[#0C3891] px-8 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 ml-0">
                Submit
              </button>
            </div>
      ...
      <div className='container my-5 mx-auto px-32'>
        <hr />
      </div>
